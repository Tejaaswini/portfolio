...
export default function Intro() {
    return (
        ...
        <div className="intro-main">
          ...
          <p align="center" className="intro-desc">A Computer Science graduate making way as a Front End Developer and a Blockchain Developer befriending <br/>Stack Overflow and GitHub. 
